...
Tool reference and full parameter lists: [docs.pinlyx.com/integrations/mcp/](https://docs.pinlyx.com/integrations/mcp/). Package: [@crmsolid/mcp-server on npm](https://www.npmjs.com/package/@crmsolid/mcp-server). Source: [github.com/Pinlyx/pinlyx-mcp](https://github.com/Pinlyx/pinlyx-mcp).
