...
The package requires Node 20 or newer, ships as ESM, and is MIT licensed. Record the resolved version in your change log and treat an upgrade as a change: review the diff between the tag you ran and the tag you are moving to, in [the source](https://github.com/CRM-Solid/crmsolid-mcp).
